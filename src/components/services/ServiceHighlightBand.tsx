...
export function ServiceHighlightBand({ kicker, heading, body, tiles }: ServiceHighlightBandProps) {
  return (
    <div className="min-w-0 rounded-2xl border border-zinc-700 bg-zinc-900/50 px-6 py-10 shadow-sm sm:px-10 sm:py-12">
      ...
      <div className="mt-10 grid min-w-0 gap-3 sm:grid-cols-3 sm:gap-4">
        {tiles.map((t) => (
          <ContentImage
            key={t.alt}
            src={t.src}
