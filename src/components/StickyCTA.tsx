...
export function StickyCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 flex w-full min-w-0 max-w-[100vw] gap-2 border-t border-zinc-200 bg-white/95 px-3 pb-safe pt-3 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/95 sm:gap-3 md:hidden">
      <a
